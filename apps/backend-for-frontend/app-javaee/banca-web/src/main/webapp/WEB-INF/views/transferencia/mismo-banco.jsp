...
<head>
    ...
    <title>Banco Nacional - Transferencia mismo banco</title>
...
<main class="main-content">
    <div class="page-header">
        ...
        <h1>🏦 Transferencia mismo banco</h1>
        <p class="page-subtitle">Transfiere a otra cuenta dentro de Banco Nacional</p>
    </div>
    ...
    <div class="form-container">
        ...
        <form method="POST" action="${pageContext.request.contextPath}/transferencia/mismo-banco" class="transfer-form">
            ...
            <div class="form-group">
                ...
                <input type="text" name="numeroCuentaDestino" id="numeroCuentaDestino"
                       placeholder="Ej: 1234567890123" maxlength="13" minlength="13"
                       pattern="[0-9]{13}" required/>
                <small class="field-hint">Ingrese los 13 dígitos de la cuenta destino en Banco Nacional</small>
            </div>
            ...
            <div class="info-box">
                <strong>ℹ Información:</strong> Las transferencias dentro de Banco Nacional
                se procesan de forma inmediata sin costo adicional.
            </div>
...
// Solo números en campo cuenta
document.getElementById('numeroCuentaDestino').addEventListener('input', function() {
