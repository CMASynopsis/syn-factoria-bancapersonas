...
source "$(script_dir_a1b2c3d4e5f6a7b8c9d0)/modules/kubectl.sh"
...
# Funciones check_kubectl, require_k8s_context, get_pod_name, get_deploy_name,
# require_pod y require_deployment se cargan desde modules/kubectl.sh
